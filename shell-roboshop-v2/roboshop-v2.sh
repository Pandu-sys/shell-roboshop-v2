...
ZONE_ID="Z03884121IOCMF4WK7QMW" # replace with your zone ID
DOMAIN_NAME="devopswithrani.online" # replace with your domain name
R="\e[31m"
G="\e[32m"
Y="\e[33m"
N="\e[0m"
    ...
    if [ $ACTION == "create" ]; then
        ...
        echo "updated R53 record for: $instance"
         ...
         if [ $INSTANCE_ID == "None" ]; then 
              ...
              echo "Termintaing Instance: $instance"
         fi
    fi 
done 
